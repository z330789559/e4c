...
module e4c_staking::config_tests {
    ...
    const PRE_CALCULATION_STAKING_REWARD: u64 = 108925;
    ...
    fun test_manual_fuzzy_on_reward_change_1() {
        reward_fuzzing(100, 30, 800, 1, 100, 67);
    }
    ...
    fun test_manual_fuzzy_on_reward_change_2() {
        reward_fuzzing(1000, 60, 1000, 100, 1000, 1670);
    }
    ...
    fun test_manual_fuzzy_on_reward_change_3() {
        reward_fuzzing(10000, 90, 1500, 100, 1000, 37500);
    }
    ...
    fun test_manual_fuzzy_on_reward_MAX_U64_1() {
        reward_fuzzing(RANGE_MAX_U64, 360, 1, 3000, RANGE_MAX_U64, 184467440737095516);
    }
    ...
    fun test_error_manual_fuzzy_on_reward_MAX_U64_2() {
        reward_fuzzing(1, 360, 1, 1, RANGE_MAX_U64, 0);
    }
    ...
    fun test_manual_fuzzy_on_reward_edge() {
        reward_fuzzing(1, RANGE_MAX_U64, 1, 1, 100, 512409557603043);
    }
    ...
    fun test_manual_fuzzy_on_reward_edge_MAX_U16() {
        reward_fuzzing(10000, 360, RANGE_MAX_U16, 1, 10000, RANGE_MAX_U16 as u64 * 100);
    }
